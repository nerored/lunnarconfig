	...
	},
	{
		...
		config = function()
			require("goto-preview").setup({
				...
				vim.cmd("nnoremap <leader>gp <cmd>lua require('goto-preview').goto_preview_definition()<CR>"),
				vim.cmd("nnoremap <leader>gP <cmd>lua require('goto-preview').goto_preview_implementation()<CR>"),
